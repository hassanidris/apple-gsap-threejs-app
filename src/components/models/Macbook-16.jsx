...
Files: macbook-16.glb [639.28KB] > /Users/hassanmansai/Desktop/Training/Development/React/apple-gsap-threejs-app/public/models/macbook-16-transformed.glb [629.72KB] (1%)
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        ...
        if (!noChangeParts.includes(child.name) && child.material.color) {
